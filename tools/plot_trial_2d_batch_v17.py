...
def _compute_gas_grid(
    ...
    *,
    ...
    # IMPORTANT: GasModelA in this repo is not vectorized (it uses Python 'if' and 'max'),
    # so we compute it ourselves in a vectorized way when we detect it.
...
def main() -> int:
    ...
    ap.add_argument("--gas_model", default="auto", help="auto|bcache|a (also accepts grid/analytic)")
